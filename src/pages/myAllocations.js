                        ...
                        return (<TabPanel key={index} value={value} index1={index} index2={0} >
                            <Box sx={{ width: '100%', padding: 0 }}>
                                    ...
                                    <Tabs value={value2} onChange={handleChange2} aria-label="basic tabs example">
                                        {
                                            t?.wing?.map((k, i = index) => {
                                                return <Tab key={i} label={k.name} {...a11yProps(index, i + 1)} />
                                            })
                                        }
                                    </Tabs>
                                </Box>
                                <TabPanel key="1" value={value2} index1={0} index2={index + 1}>
                                    <br />
                                    <Hall building={props.building} floor={t.floor} zone="A" user={props?.user} getAddToList={getAddToList} />
                                </TabPanel>
                                <TabPanel key="2" value={value2} index1={1} index2={index + 1} >
                                    <br />
                                    <Hall  building={props.building} floor={t.floor} zone="B" user={props?.user} getAddToList={getAddToList} />
                                </TabPanel>
                                <TabPanel key="3" value={value2} index1={2} index2={index + 1}>
                                    <br />
                                    <Hall  building={props.building} floor={t.floor} zone="C" user={props?.user} getAddToList={getAddToList} />
                                </TabPanel>
                                <TabPanel key="4" value={value2} index1={3} index2={index + 1}>
                                    <br />
                                    <Hall  building={props.building} floor={t.floor} zone="D" user={props?.user} getAddToList={getAddToList} />
                                </TabPanel>
                            </Box>
                        </TabPanel>)
                    })
